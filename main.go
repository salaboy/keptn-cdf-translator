...
var KEPTN_ENDPOINT = os.Getenv("KEPTN_ENDPOINT")
var KEPTN_API_TOKEN = os.Getenv("KEPTN_API_TOKEN")
...
var registry = handlers.CDEventHandlerRegistry{}
var artifactExtension = cdeextensions.ArtifactExtension{}
